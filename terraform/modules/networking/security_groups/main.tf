...
resource "aws_security_group" "lambda_to_db_security_group" {
...
resource "aws_vpc_security_group_egress_rule" "lambda_to_rds" {
  security_group_id            = aws_security_group.lambda_to_db_security_group.id
...
resource "aws_vpc_security_group_ingress_rule" "rds_from_lambda" {
  ...
  referenced_security_group_id = aws_security_group.lambda_to_db_security_group.id
}
